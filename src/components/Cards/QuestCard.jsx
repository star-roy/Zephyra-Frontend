...
export default function QuestCard({ quest }) {
  ...
  return (
    <div
      className="bg-white rounded-3xl shadow-2xl border border-purple-100 h-80 max-w-sm flex flex-col overflow-hidden cursor-pointer transition-all duration-300 ease-in-out relative hover:shadow-purple-300/40 group"
