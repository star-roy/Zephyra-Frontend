      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm sm:text-base text-stormyGrey">
            <span className="font-semibold text-midnightIndigo">Hi Explorer!</span>{" "}
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 mb-4 max-w-3xl mx-auto">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <button className="bg-zephyraBlue hover:bg-zephyraDark text-white font-semibold text-sm sm:text-base px-5 py-3 rounded-full transition">
              Send
            </button>
          </div>
